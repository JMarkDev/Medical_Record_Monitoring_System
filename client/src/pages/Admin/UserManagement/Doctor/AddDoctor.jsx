...
import VerifyOTP from "../../../Verification/AdminOTP";
...
const AddDoctor = ({ modal, closeModal }) => {
  ...
  const onVerificationSuccess = () => {
    dispatch(fetchUsers(rolesList?.doctor));
  };
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      formData.append("availability_start_time", data.availability_start_time);
